...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference("Call.count") do
      post calls_url, params: { call: { client_id: @call.client_id, reason_id: @call.reason_id, user_id: @call.user_id } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { client_id: @call.client_id, reason_id: @call.reason_id, user_id: @call.user_id } }
